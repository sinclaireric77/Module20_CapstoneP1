...
There are a total of 6 files (+datafiles) in this repository (1 readme.md; 1 jupyter notebook – Capstone_v03.ipynb in the main folder and 4 images in the images folder)
